...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($apitoken == '0') {
        ...
        echo json_encode(array('status' => 'error', 'message' => 'Authorization key is already disabled.'));
        die();
    }
    if (empty($errors)) {
        ...
        echo json_encode(array('status' => 'success', 'message' => 'Authorization key successfully disabled.'));
        die();
    }
}
?>