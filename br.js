...
console.log(colors.red("RPS: 512"))
    ...
    async function addsession() {
        try {
            ...
            solving({
                ...
                console.log(colors.red('GARUDA-BROWSER ATTACK STARTED!!!!');
    ...
    for (let start = 0; start < threads; start++) {
        console.log(colors.red('GARUDA-BROWSER ATTACK STARTED!!!!'), 'Create session: #' + start);
			addsession();
    }
}
...
function solving(message) {
    return new Promise((resolve, reject) => {
        console.log(colors.red('GARUDA-BROWSER ATTACK STARTED!!!!'), 'Proxy added: ' + message.proxoid);
