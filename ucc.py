...
╚══██╔══╝██╔════╝██╔══██╗████╗ ████║    ██║   ██║██╔════╝██╔════╝
   ...
   ██║   ███████╗██║  ██║██║ ╚═╝ ██║    ╚██████╔╝╚██████╗╚██████╗
   ╚═╝   ╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝     ╚═════╝  ╚═════╝ ╚═════╝ 
         ANON_SEC_101 x TEAM UCC DEFACE TOOL V1                         
         CREDITS = MR.ODIYAN - STR4NG3   
"""+reset+blue

def animate():

    text = "Wait Sir, Uploading your script to websites..."
...
def main(__bn__):
   ...
   while True:
      ...
      try:
         ...
         print(green+'[THIS TOOL IS OFFICIALLY MADE BY TeAm UcC -{ OxD3V1L }]'+reset+blue)

         print(' ')

         a = eagle(green+"[+]\033[0m \033[34mEnter your deface script's name \033[33m[.html]\033[0m \033[34m> ")
